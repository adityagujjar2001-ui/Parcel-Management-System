...
public class Database {
    private static final String ROOT_DB_URL = "jdbc:mysql://localhost:3306/?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";
    private static final String DB_URL = "jdbc:mysql://localhost:3306/addydb?useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=UTC";
    ...
    private static void ensureDatabase() throws SQLException {
        try (Connection rootConnection = DriverManager.getConnection(ROOT_DB_URL, DB_USER, DB_PASSWORD);
            ...
            statement.executeUpdate("CREATE DATABASE IF NOT EXISTS addydb");
        }
